    ...
    try {
      ...
      const meditationsData = [
        { title: "For Beginners", category: "beginner", content: [
          { title: "Introduction to Meditation", description: "A beginner-friendly meditation introduction.", pic: intro1 },
          { title: "Breathing Techniques", description: "Learn simple breathing techniques for relaxation.", pic: intro2 },
          { title: "Body Scan Meditation", description: "A guided meditation to scan and relax your body.", pic: intro3 }
        ] },
        { title: "Quick and Easy", category: "quick_easy", content: [
          { title: "5-Minute Mindfulness", description: "Quick mindfulness exercises for busy days.", pic: quick1 },
          { title: "Stress Relief", description: "Instant stress relief techniques.", pic: quick2 },
          { title: "Morning Meditation", description: "Start your day with a short morning meditation.", pic: quick3}
        ] },
        ...
        { title: "Not in a good mood? Feel better", category: "low", content: [
          ...
          { title: "Winter rhythm", description: "Embrace the tranquility of winter.", pic: low1},
          ...
          { title: "Enchanted garden", description: "Step into an enchanted garden and experience relaxation.", pic: low2 },
          // Image by <a href="https://pixabay.com/users/wokandapix-614097/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=2525787">WOKANDAPIX</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=2525787">Pixabay</a>
          ...
          { title: "Serenity Symphony", description: "Immerse yourself in a serene symphony of sounds.", pic: low3 }
        ] },
...
<div className="emotion-box" style={{backgroundImage: `url(${hardBreathe})`, backgroundSize: 'cover', backgroundPosition: 'center'}}>
  <div className="breatheHard">Hard to Breathe?</div>
        ...
        <div className="filter-categories">
          ...
          <button className={selectedCategory === "low" ? "active" : ""} onClick={() => filterMeditations("low")}>Low mood?</button>

...
function Interests() {
  ...
  const handleNavigationToProfileSetup = () => {
      ...
      <div className="int-interest-btn">
        <div className="int-btn-container">
          ...
          <div className="int-btn-4">
            <button
              className={isActive.business ? "active" : ""}
          ...
          <div className="int-btn-6">
            <button
              className={isActive.maths ? "active" : ""}
              onClick={() => toggleButton("maths")}
            >
              Maths
            </button>
          </div>
        ...
        <div>
          <button className="int-go-to-login" onClick={handleNavigationToLogin}>
            Confirm
          </button>
        </div>
        <div>
          <button
            className="int-go-to-profile-setup"
            onClick={handleNavigationToProfileSetup}
          >
            Back
          </button>
        </div>
